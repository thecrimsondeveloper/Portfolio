...
- Active packet reason: An enemy archetype creates readable pressure and validates ember/hazard interactions.
- Active sprint objective: Implement the one enemy archetype slice so the player can reliably feel ember under sentry.
- Active player promise: The player immediately feels how one enemy archetype improves the route and unlocks uncover.
- Current pass goal: Implement one enemy archetype (Ember Sentry) that interacts with ember pulses and hazards.
