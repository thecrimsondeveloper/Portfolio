...
- Active sprint objective: Implement the movement slice so the player can reliably feel sprint under warden.
- Active player promise: The player immediately feels how movement improves the route and unlocks unify.
- Current pass goal: Build the first playable implementation passes for Overgrown Artifacts: Guard Break.
