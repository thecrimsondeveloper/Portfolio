...
- Sprint goal: Build the first playable implementation passes for Overgrown Artifacts: Guard Break.
		- Pass goal: Build the first playable implementation passes for Overgrown Artifacts: Guard Break.
