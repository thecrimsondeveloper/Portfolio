# Movement Change Packet
			...
			Implement the movement slice so the player can reliably feel while under commander.

			## Player Promise

			The player immediately feels how movement improves the route and unlocks discover.
