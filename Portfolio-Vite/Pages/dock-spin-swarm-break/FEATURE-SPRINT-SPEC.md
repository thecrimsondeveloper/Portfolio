...
- Active packet reason: Movement is the fundamental building block of the 'Dock Spin' identity. Without the spin-dash and relay-pacing, it's just a generic runner.
- Active sprint objective: Implement the movement slice so the player can reliably feel spin under shock.
- Active player promise: The player immediately feels how movement improves the route and unlocks refine.
- Current pass goal: Implement the movement slice so the player can reliably feel spin under shock.
