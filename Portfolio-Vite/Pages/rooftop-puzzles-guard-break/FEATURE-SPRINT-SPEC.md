...
- Active feature: (Pending active feature selection.)
- Active packet reason: (Pending active packet reasoning.)
- Active sprint objective: (Pending active sprint objective.)
- Active player promise: (Pending active player promise.)
- Current pass goal: (Pending pass goal.)
