...
- Movement mechanics: grapple and zipline, slide and vault
- Core loops: solve motion puzzles to advance
- Progression loops: restore environmental systems
- Completion loops: tower climb to trigger signal
- Rewards: artifact sets, collectibles
- Antagonists: patrolling automatons
- Visual styles: warm neon
...
- Use puzzles and ember interactions to survive, reposition, and secure objectives.
...
- Shift triggers a motion burst for repositioning.
...
### One Route Hazard
				...
				- Sprint objective: Implement the one route hazard slice so the player can reliably feel motion under noir.
				- Change packet scope: game.js, story-structure.json, index.html
...
## Fun Game Assessment
		...
		- Assessment: yes - Rooftop Puzzles: Guard Break has a readable arcade core built around sprint, crash against warden, leader with a clear payoff in unify, evolve.
